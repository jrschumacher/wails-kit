module github.com/jrschumacher/wails-kit/frontend
...
require (
	...
	github.com/jrschumacher/wails-kit/updates v0.0.0-00010101000000-000000000000
)
...
replace (
	...
	github.com/jrschumacher/wails-kit/updates => ../updates
)
